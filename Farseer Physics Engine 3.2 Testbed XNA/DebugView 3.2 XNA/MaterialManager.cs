...
namespace FarseerPhysics.DebugViews
{
    ...
    {
        Blank, Circles, Dots, Face, Squares, Stars, Tiles, Waves, Pavement, Background, BlueHero, RedHero,
        Triangle, Square, Pentagon, Hexagon, Octagon, Septagon
    }
    ...
    public class MaterialManager
    {
        ...
        public void LoadContent(ContentManager contentManager)
        {
            ...
            _materials[MaterialType.Background] = contentManager.Load<Texture2D>("Materials/background");
            _materials[MaterialType.BlueHero] = contentManager.Load<Texture2D>("Materials/Circle_hero_blue");
            _materials[MaterialType.RedHero] = contentManager.Load<Texture2D>("Materials/Circle_hero_red");
            _materials[MaterialType.Triangle] = contentManager.Load<Texture2D>("Materials/Triangle");
            _materials[MaterialType.Square] = contentManager.Load<Texture2D>("Materials/Square");
            _materials[MaterialType.Pentagon] = contentManager.Load<Texture2D>("Materials/Pentagon");
            _materials[MaterialType.Hexagon] = contentManager.Load<Texture2D>("Materials/Hexagon");
            _materials[MaterialType.Octagon] = contentManager.Load<Texture2D>("Materials/Octagon");
            _materials[MaterialType.Septagon] = contentManager.Load<Texture2D>("Materials/Septagon");
        }
